...
| <a name="input_grafana_data_sources"></a> [grafana\_data\_sources](#input\_grafana\_data\_sources) | A list of data sources that should be configured in AWS Managed Grafana Workspace | `list(string)` | <pre>[<br>  "CLOUDWATCH",<br>  "PROMETHEUS"<br>]</pre> | no |
